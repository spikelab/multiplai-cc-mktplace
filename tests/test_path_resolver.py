...
class TestModuleSingleton:
    ...
    def test_module_level_paths_is_paths_instance(self, reset_paths_cache):
        ...
        from lib.paths import paths, Paths
...
class TestSysPathSetup:
    """Block spec: sys.path setup allows `from lib.paths import paths`
    from any scripts/*.py file.
    """

    def test_lib_paths_importable(self):
        """from lib.paths import paths must work."""
        from lib.paths import paths

        assert paths is not None

    def test_lib_paths_get_paths_importable(self):
        """from lib.paths import get_paths must work."""
