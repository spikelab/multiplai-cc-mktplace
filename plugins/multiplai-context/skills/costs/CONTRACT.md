...
```sh
uv run --project ../../scripts ../../scripts/costs_report.py --by nonsense 2>&1 || true
```
...
```sh
uv run --project ../../scripts ../../scripts/costs_report.py --json 2>/dev/null | python3 -c "import json,sys; d=json.load(sys.stdin); print('json-ok')"
```
