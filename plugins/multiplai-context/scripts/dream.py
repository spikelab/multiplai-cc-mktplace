...
- Group updates by target memory file. Do NOT print per-file learning counts, source
  filenames, "seen Nx" repetition notes, or trust levels — they cost tokens and serve no one.
...
Do NOT: add entries, change section groupings, re-judge clean entries, reorder, or touch
anything already clean. PRESERVE the exact output format and any **[RULE-PROPOSAL]** /
**[warning low confidence]** markers. Renumber entries only if you moved one to Filtered Out.
